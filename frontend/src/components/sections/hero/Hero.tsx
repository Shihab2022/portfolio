  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center z-20">
            ...
            <div className="h-12 sm:h-16 flex items-center overflow-hidden">
              <AnimatePresence mode="wait">
                <motion.p
                  ...
                  className="text-2xl sm:text-3xl md:text-4xl font-extrabold bg-clip-text text-transparent bg-linear-to-r from-blue-400 via-indigo-200 to-cyan-400"
                >
        ...
        >
          <div
            className="relative group w-72 h-72 sm:w-96 sm:h-96 md:w-105 md:h-130 
          rounded-3xl p-3 bg-linear-to-br from-white/10 to-white/0 backdrop-blur-xs border
           border-white/10 shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] transition-transform duration-500
            hover:rotate-3 hover:scale-105"
          >
            <div
              className="absolute inset-0 rounded-3xl bg-linear-to-tr
             from-cyan-500/20 via-transparent to-purple-700/30 opacity-0 
            ...
            <div className="relative w-full h-full rounded-2xl overflow-hidden bg-slate-950/40">
              <div
                className="absolute inset-0 bg-linear-to-t from-[#0F172A]/80 
              ...
              <Image
                ...
                priority
                className="w-full h-full object-cover transform scale-100 group-hover:scale-115 
                transition-transform duration-700 filter grace-grayscale-0 ease-in-out"
