        ...
        {contactConfig.socials.map((social) => {
          ...
          return (
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className={`flex items-center justify-center w-10 h-10 rounded-xl border border-white/5 bg-white/[0.01] text-slate-400 transition-all duration-300 hover:bg-white/[0.03] hover:border-white/10 shadow-inner group ${social.color}`}
